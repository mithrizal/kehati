...
class Subscriber extends CI_Controller {
    ...
    public function home($data) {
        $data['content_view'] = "backend/subscriber.php";
        $data['page_title'] = "Subscriber - Kehati Admin";
        $data['subscribers'] = $this->Subscriber_model->getList();
        $data['page_header'] = "Subscriber";
        $data['page_desc'] = "modul master for maintenance subscriber data.";
    ...
    public function delete() {
        ...
        if ($this->input->post('deleted_id') != '') {
            ...
            $this->Subscriber_model->deleteSubscriber($id);
